...
<form method="POST" action="proses_pelanggan.php">
  ...
  <div class="form-group row">
    <label for="stok" class="col-4 col-form-label">Jenis kelamin</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="jenis" class="col-4 col-form-label">Tanggal lahir</label> 
    <div class="col-8">
        <?php 
